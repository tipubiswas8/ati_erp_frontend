    ...
    <div :class="modal_class"
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
        ...
        <div class="mb-6 flex flex-col">
          <label for="project_id" class="text-lg font-medium text-gray-900 mb-2">{{ $t("Project Name") }}</label>
        ...
        <!-- Department -->
        <div class="mb-6 flex flex-col">
          <label for="department_id" class="text-lg font-medium text-gray-900 mb-2">{{ $t("Department") }}</label>
        ...
        <!-- Description -->
        <div class="mb-6 flex flex-col">
          <label for="description" class="text-lg font-medium text-gray-900 mb-2">{{ $t("Description") }}</label>
        ...
        <!-- Attachment -->
        <div class="mb-6 flex flex-col">
          <label for="attachment" class="text-lg font-medium text-gray-900 mb-2">{{ $t("Attachment") }}</label>
...
async function submitForm() {
  try {
    ...
    if (response.data && response.data.meta.http_status === 201) {
