...
const basePath = globals.apiEndpoints.basePath;
...
const sendDataToTable = {
  urls: {
    'data_url': basePath + '/hr/employees',
    'view_url': basePath + 'hr/employees',
    'edit_url': basePath + 'hr/employees',
    'status_url': basePath + 'hr/employees',
    'delete_url': basePath + 'hr/employees'
  },
