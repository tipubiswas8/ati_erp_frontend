    ...
    <div :class="themeBlock" class="flex-1 w-full pt-14 p-4 space-y-8 relative min-h-screen">
        <div class="mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div v-show="currentStep === 1">
                <ShowBasicInformation :emp-info="employee" />
            </div>
            <div v-show="currentStep === 2">
                <ShowFamilyInformation />
            </div>
            <div v-show="currentStep === 3">
                <ShowGuardianInformation />
            </div>
            <div v-show="currentStep === 4">
                <ShowJobInformation />
            </div>
            <div v-show="currentStep === 5">
                <ShowProbationaryInformation />
            </div>
            ...
            <div v-show="currentStep === 9">
                <ShowTrainingInformation v-bind:emp-info="employee" />
            </div>
            ...
            <div style="margin-left: 50px; margin-right: 50px; margin-bottom: 50px;">
                <div class="flex mt-8 pt-6 border-t border-gray-200">
                    ...
                    <button v-if="currentStep < steps.length" @click="nextStep" type="button"
                        class="px-6 py-3 bg-indigo-600 text-white rounded-lg hover:bg-indigo-800 transition-all duration-200 flex items-center ml-auto">
                        Next
...
import ShowBasicInformation from '../Show/ShowBasicInformation.vue';
import ShowFamilyInformation from '../Show/ShowFamilyInformation.vue';
import ShowGuardianInformation from '../Show/ShowGuardianInformation.vue';
import ShowJobInformation from '../Show/ShowJobInformation.vue';
import ShowProbationaryInformation from '../Show/ShowProbationaryInformation.vue';
import ShowContactInformation from '../Show/ShowContactInformation.vue';
import ShowAddressInformation from '../Show/ShowAddressInformation.vue';
import ShowEducationInformation from '../Show/ShowEducationInformation.vue';
import ShowTrainingInformation from '../Show/ShowTrainingInformation.vue';
import ShowProfessionalInformation from '../Show/ShowProfessionalInformation.vue';
import ShowExperienceInformation from '../Show/ShowExperienceInformation.vue';
import ShowReferenceInformation from '../Show/ShowReferenceInformation.vue';
import ShowDocumentInformation from '../Show/ShowDocumentInformation.vue';
import ShowTerminationInformation from '../Show/ShowTerminationInformation.vue';
...
const empInfo = useEmployeeStore();
const employee = empInfo.currentEmployee;
