      ...
      >
        <thead :class="headerClass">
          <tr class="text-left text-sm font-semibold uppercase">
            <th
              v-if="tableHeaders.columnNo1.visibility"
            ...
            <th
              v-if="tableHeaders.columnNo2.visibility"
              class="p-4 text-center"
            >
            ...
            <th
              v-if="tableHeaders.columnNo3.visibility"
              class="p-4 text-center"
            >
              <div class="flex items-center">
                <input
            ...
            <th
              v-if="tableHeaders.columnNo4.visibility"
              class="p-4 text-center"
            >
              <div class="flex items-center">
                <input
            ...
            <th
              v-if="tableHeaders.columnNo5.visibility"
              class="p-4 text-center"
            >
              <div class="flex items-center">
                <input
            ...
            <th
              v-if="tableHeaders.columnNo6.visibility"
              class="p-4 text-center"
            >
              <div class="flex items-center">
                <input
        ...
        <tbody :class="themeClass">
          <template
            v-for="(task, index) in sortedAndPaginatedTasks"
            :key="task.task_id"
          >
            <tr :class="getRowClass(index)">
              ...
              <td v-if="tableHeaders.columnNo1.visibility" class="p-4">
                <span class="text-blue-600">{{ task.task_id }}</span>
              </td>
              <td v-if="tableHeaders.columnNo2.visibility" class="p-4">
                <span class="text-blue-600">{{ task.project_name }}</span>
              </td>
              <td v-if="tableHeaders.columnNo3.visibility" class="p-4">
                <span class="text-blue-600">{{ task.department_name }}</span>
              </td>
              <td v-if="tableHeaders.columnNo4.visibility" class="p-4">
                <span class="text-blue-600">{{ task.task_title }}</span>
              </td>
              <td v-if="tableHeaders.columnNo5.visibility" class="p-4">
                <span class="text-blue-600">{{ task.task_description }}</span>
              </td>
            ...
            <EditPage
              v-if="expandedIndex === index + (currentPage - 1) * itemsPerPage"
