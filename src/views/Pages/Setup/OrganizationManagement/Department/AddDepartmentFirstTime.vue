        ...
        <div class="flex flex-wrap -mx-2">
          <div class="w-full md:w-full px-2">
            ...
            <div class="w-full mb-4">
              <label class="block text-md font-medium text-gray-900 mb-2">Organization</label>
              <select v-model="form.organization_id" required
                class="w-full border border-gray-300 rounded-lg p-2 text-gray-800 text-sm">
                <option value="">Select</option>
                <option v-for="organization in organizations" :key="organization.org_id" :value="organization.org_id">
